...
#read_csv = read.csv('https://raw.githubusercontent.com/Diane-12/BD_Pytoreactiva/main/pyto_reactica_12_original_vs2.csv', encoding='utf-8')
...
as.numeric(bd_reactiva_pyto$MONTODETRANSFERENCIA2020)
...
#si se quiere trabajar con BD de un archivo excel
#library(readxl)
...
class(bd_reactiva_pyto$REGION)
class(bd_reactiva_pyto$MONTODETRANSFERENCIA2020)

stringr::str_remove_all()

sum(bd_reactiva_pyto$MONTODETRANSFERENCIA2020)
